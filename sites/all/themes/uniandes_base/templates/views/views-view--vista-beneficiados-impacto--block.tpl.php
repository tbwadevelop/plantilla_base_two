...
if (!empty($resultados)){
	?>
	<section class="block-views-vista-beneficiados" id="beneficiario-detalle">
				...
				foreach ($resultados as $item) {
					...
					<article class="item-list-people-benefited">
						...
						<div class="txt-people-benefited">
							<a class="link-beneficiarios" href="<?php print url( 'node/' . $beneficiado->nid, array('absolute'=>true)); ?>">
