        ...
        foreach ($resultados as $resultado_ind){
            ...
            <li>
                <a <?php print $target; ?> href="<?php  print $url ?>">
                 <img src="<?php print file_create_url( $noticia->field_image_desktop["und"][0]["uri"] ) ?>" class='img-responsive' alt="<?php print $noticia->field_image_desktop["und"][0]["alt"] ?>" title="<?php print $noticia->field_image_desktop["und"][0]["title"] ?>" >
