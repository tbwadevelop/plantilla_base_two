...
<a href="/donaciones/historias-increibles/">Historias Increíbles</a>
...
foreach ($node->field_imagenes_noticias["und"] as $imagen_grande){
  ...
  <article class="item-slide-for-detail">
    <figure>
     ...
     <img id="img_desktop" src="<?php print file_create_url( $imagen_grande["uri"] ) ?>" alt="<?php print $imagen_grande["alt"] ?>" title="<?php print $imagen_grande["title"] ?>" >
