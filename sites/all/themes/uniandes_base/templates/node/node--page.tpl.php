...
"description" : "<?php echo trim( drupal_html_to_text( $node->field_texto_competo_noticias["und"][0]["value"] ) ) ?>",
<?php } ?>
<?php if( isset( $node->field_videos_noticias_v2 ) ){ ?>
"video": "<?php print trim( drupal_html_to_text( $node->field_videos_noticias_v2["und"][0]["image_field_caption"]["value"] ) ) ?>"
<?php } ?>
